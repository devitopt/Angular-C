...
namespace API.ModelsDB
{
    public partial class Order
    {
        public Order()
        {
            ...
            FabricStatusReports = new HashSet<FabricStatusReport>();
            FactoryConnections = new HashSet<FactoryConnection>();
            OrderGroups = new HashSet<OrderGroup>();
            OrderMarkdowns = new HashSet<OrderMarkdown>();
            OrderMarkups = new HashSet<OrderMarkup>();
            OrderStyleMarkdowns = new HashSet<OrderStyleMarkdown>();
            OrderStyleMarkups = new HashSet<OrderStyleMarkup>();
        ...
        public virtual ICollection<FabricStatusReport> FabricStatusReports { get; set; }
        ...
        public virtual ICollection<OrderMarkdown> OrderMarkdowns { get; set; }
        public virtual ICollection<OrderMarkup> OrderMarkups { get; set; }
        public virtual ICollection<OrderStyleMarkdown> OrderStyleMarkdowns { get; set; }
        public virtual ICollection<OrderStyleMarkup> OrderStyleMarkups { get; set; }
