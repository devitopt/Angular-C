...
namespace API.ModelsDB
{
    public partial class DBContext : DbContext
    {
        ...
        public virtual DbSet<FabricStatusReport> FabricStatusReports { get; set; }
        ...
        public virtual DbSet<MarkdownType> MarkdownTypes { get; set; }
        public virtual DbSet<MarkupType> MarkupTypes { get; set; }
        ...
        public virtual DbSet<OrderMarkdown> OrderMarkdowns { get; set; }
        ...
        public virtual DbSet<OrderStyleMarkdown> OrderStyleMarkdowns { get; set; }
        public virtual DbSet<OrderStyleMarkup> OrderStyleMarkups { get; set; }
        ...
        public virtual DbSet<SportStatus> SportStatuses { get; set; }
        ...
        public virtual DbSet<TabImportOldDataFromAccessCenterline> TabImportOldDataFromAccessCenterlines { get; set; }
        public virtual DbSet<TabReportNachVertreterAccessDataCenterline> TabReportNachVertreterAccessDataCenterlines { get; set; }
        ...
        public virtual DbSet<VCubeReportNachVertreterNonUniqueBackup> VCubeReportNachVertreterNonUniqueBackups { get; set; }
        ...
        public virtual DbSet<VDprSport> VDprSports { get; set; }
        ...
        public virtual DbSet<VDprqbrow> VDprqbrows { get; set; }
        ...
        public virtual DbSet<VProductionStatusHistory> VProductionStatusHistories { get; set; }
        ...
        public virtual DbSet<VSportAnalysis> VSportAnalyses { get; set; }
        public virtual DbSet<VSportStatusRow> VSportStatusRows { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=yoursever\\instance;Database=databasename;User=username;Password=password");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdditionalOrderInformation>(entity =>
            {
                ...
                entity.Property(e => e.ReSamplePickDate).HasColumnType("date");
                ...
                entity.HasOne(d => d.Tenant)
                    ...
                    .HasConstraintName("FK_AdditionalOrderInformation_Tenant");
            });
            ...
            modelBuilder.Entity<FabricStatusReport>(entity =>
            {
                entity.ToTable("FabricStatusReport");

                entity.Property(e => e.FabricStatusReportId).HasColumnName("FabricStatusReportID");

                entity.Property(e => e.Bvresult)
                    .IsRequired()
                    .HasMaxLength(512)
                    .HasColumnName("BVresult");

                entity.Property(e => e.BvselftestingDate)
                    .HasColumnType("date")
                    .HasColumnName("BVselftestingDate");

                entity.Property(e => e.CoatingBonding)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.DyeingPrinting)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.DyeingPrintingQtySupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FabricSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FabricUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionAirpermeability)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionBreathability)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionEmpty)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionMoistureManagement)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionResultAirpermeability)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionResultBreathability)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionResultMoistureManagement)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionResultSprayTest)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionResultWaterColumn)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionSprayTest)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.FunctionWaterColumn)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.GarmentSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Gpextern)
                    .IsRequired()
                    .HasMaxLength(512)
                    .HasColumnName("GPextern");

                entity.Property(e => e.GreigeQtySupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan1stLotDate).HasColumnType("date");

                entity.Property(e => e.InspectionPlan1stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan1stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan2stLotDate).HasColumnType("date");

                entity.Property(e => e.InspectionPlan2stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan2stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan3stLotDate).HasColumnType("date");

                entity.Property(e => e.InspectionPlan3stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan3stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan4stLotDate).HasColumnType("date");

                entity.Property(e => e.InspectionPlan4stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan4stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan5stLotDate).HasColumnType("date");

                entity.Property(e => e.InspectionPlan5stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.InspectionPlan5stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);
                ...
                entity.Property(e => e.LabDipsHandloomDate).HasColumnType("date");

                entity.Property(e => e.LabtechResult)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.LabtechRetestingDate).HasColumnType("date");

                entity.Property(e => e.OriginalFabricDate).HasColumnType("date");

                entity.Property(e => e.OriginalFabricSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.QualityDate).HasColumnType("date");

                entity.Property(e => e.Remarks)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Sachbearbeiter)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment1stLotDate).HasColumnType("date");

                entity.Property(e => e.Shipment1stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment1stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment2stLotDate).HasColumnType("date");

                entity.Property(e => e.Shipment2stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment2stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment3stLotDate).HasColumnType("date");

                entity.Property(e => e.Shipment3stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment3stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment4stLotDate).HasColumnType("date");

                entity.Property(e => e.Shipment4stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment4stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment5stLotDate).HasColumnType("date");

                entity.Property(e => e.Shipment5stLotSupplier)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Shipment5stLotUnit)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.Spinning)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.Property(e => e.StatusDate).HasColumnType("date");

                entity.Property(e => e.WeavingKnitting)
                    .IsRequired()
                    .HasMaxLength(512);

                entity.HasOne(d => d.Order)
                    .WithMany(p => p.FabricStatusReports)
                    .HasForeignKey(d => d.OrderId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FabricStatusReport_Orders");
            });
            ...
            modelBuilder.Entity<MarkdownType>(entity =>
            {
                entity.HasKey(e => e.MarkdownId)
                    .HasName("PK_Markdowns");

                entity.ToTable("MarkdownType");
            ...
            modelBuilder.Entity<MarkupType>(entity =>
            {
                entity.HasKey(e => e.MarkupId)
                    .HasName("PK_Markups");

                entity.ToTable("MarkupType");
            ...
            modelBuilder.Entity<OrderMarkdown>(entity =>
            {
                entity.ToTable("OrderMarkdown");

                entity.Property(e => e.Markdown).HasColumnType("decimal(8, 4)");

                entity.Property(e => e.MarkdownExchangeRate).HasColumnType("decimal(8, 4)");

                entity.HasOne(d => d.MarkdownCurrencyNavigation)
                    .WithMany(p => p.OrderMarkdowns)
                    .HasForeignKey(d => d.MarkdownCurrency)
                    .HasConstraintName("FK_OrderMarkdown_Currencies");

                entity.HasOne(d => d.Order)
                    .WithMany(p => p.OrderMarkdowns)
                    .HasForeignKey(d => d.OrderId)
                    .HasConstraintName("FK_OrderMarkdown_Orders");
            });
            ...
            modelBuilder.Entity<OrderStyleMarkdown>(entity =>
            {
                entity.ToTable("OrderStyleMarkdown");
                ...
                entity.HasOne(d => d.MarkdownCurrencyNavigation)
                    .WithMany(p => p.OrderStyleMarkdowns)
                    .HasForeignKey(d => d.MarkdownCurrency)
                    .HasConstraintName("FK_OrderStyleMarkdown_Currencies");

                entity.HasOne(d => d.Order)
                    .WithMany(p => p.OrderStyleMarkdowns)
                    .HasForeignKey(d => d.OrderId)
                    .HasConstraintName("FK_OrderStyleMarkdown_Orders");
            });

            modelBuilder.Entity<OrderStyleMarkup>(entity =>
            {
                entity.ToTable("OrderStyleMarkup");
                ...
                entity.HasOne(d => d.MarkupCurrencyNavigation)
                    .WithMany(p => p.OrderStyleMarkups)
                    .HasForeignKey(d => d.MarkupCurrency)
                    .HasConstraintName("FK_OrderStyleMarkup_Currencies");

                entity.HasOne(d => d.Order)
                    .WithMany(p => p.OrderStyleMarkups)
                    .HasForeignKey(d => d.OrderId)
                    .HasConstraintName("FK_OrderStyleMarkup_Orders");
            });
            ...
            modelBuilder.Entity<SportStatus>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("SportStatus");

                entity.Property(e => e.AribaConfirmationDate).HasColumnType("date");

                entity.Property(e => e.BuyingAgent).HasMaxLength(250);

                entity.Property(e => e.CargoReadyDate).HasColumnType("date");

                entity.Property(e => e.CartonHeight).HasColumnType("decimal(6, 2)");

                entity.Property(e => e.CartonLength).HasColumnType("decimal(6, 2)");

                entity.Property(e => e.CartonWidth)
                    .HasColumnType("decimal(6, 2)")
                    .HasColumnName("cartonWidth");

                entity.Property(e => e.Comment).HasMaxLength(500);

                entity.Property(e => e.Ctsdate)
                    .HasColumnType("date")
                    .HasColumnName("CTSDate");

                entity.Property(e => e.Ctsresult)
                    .HasMaxLength(250)
                    .HasColumnName("CTSResult");

                entity.Property(e => e.FabricExDate).HasColumnType("date");

                entity.Property(e => e.FabricInhouseDate).HasColumnType("date");

                entity.Property(e => e.FabricSupplier).HasMaxLength(250);

                entity.Property(e => e.GraphicOrder).HasColumnType("date");

                entity.Property(e => e.Graphics).HasMaxLength(250);

                entity.Property(e => e.Ibnumber)
                    .HasMaxLength(50)
                    .HasColumnName("IBNumber");

                entity.Property(e => e.InfoblattDate).HasColumnType("date");

                entity.Property(e => e.LabelDate).HasColumnType("date");

                entity.Property(e => e.LabelResult).HasMaxLength(250);

                entity.Property(e => e.MerchandiserPacking).HasMaxLength(250);

                entity.Property(e => e.OekotexDate).HasColumnType("date");

                entity.Property(e => e.OekotexResult).HasMaxLength(250);

                entity.Property(e => e.OpticalPattern).HasMaxLength(250);

                entity.Property(e => e.OrderSheetDate).HasColumnType("date");

                entity.Property(e => e.PackingDate).HasColumnType("date");

                entity.Property(e => e.PackingResult).HasMaxLength(250);

                entity.Property(e => e.PdppassformDate)
                    .HasColumnType("date")
                    .HasColumnName("PDPPassformDate");

                entity.Property(e => e.PdppassformResult)
                    .HasMaxLength(50)
                    .HasColumnName("PDPPassformResult");

                entity.Property(e => e.Sample).HasMaxLength(250);

                entity.Property(e => e.SportStatusId).ValueGeneratedOnAdd();

                entity.Property(e => e.StatusDate).HasColumnType("date");

                entity.Property(e => e.SubmitVvp)
                    .HasColumnType("date")
                    .HasColumnName("SubmitVVP");

                entity.Property(e => e.SubmittPdp)
                    .HasColumnType("date")
                    .HasColumnName("SubmittPDP");

                entity.Property(e => e.Technician).HasMaxLength(250);

                entity.Property(e => e.VpppassformDate)
                    .HasColumnType("date")
                    .HasColumnName("VPPPassformDate");

                entity.Property(e => e.VpppassformResult)
                    .HasMaxLength(50)
                    .HasColumnName("VPPPassformResult");

                entity.Property(e => e.ZcartonsNord)
                    .HasColumnType("date")
                    .HasColumnName("ZCartonsNord");
            });
            ...
            modelBuilder.Entity<TabImportOldDataFromAccessCenterline>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("tab_Import_OldDataFromAccess_Centerline");

                entity.Property(e => e.Artikel).HasMaxLength(250);
                ...
                entity.Property(e => e.Kunde).HasMaxLength(250);

                entity.Property(e => e.Kw).HasColumnName("KW");

                entity.Property(e => e.Land).HasMaxLength(250);

                entity.Property(e => e.Lc)
                    .HasMaxLength(250)
                    .HasColumnName("LC");

                entity.Property(e => e.Lcer).HasColumnName("lcer");

                entity.Property(e => e.Lieferant).HasMaxLength(250);
                ...
                entity.Property(e => e.Oauftrag).HasColumnName("oauftrag");

                entity.Property(e => e.Order).HasMaxLength(250);
                ...
                entity.Property(e => e.Saison).HasMaxLength(250);

                entity.Property(e => e.Techniker).HasMaxLength(250);
                ...
                entity.Property(e => e.Vertreter).HasMaxLength(250);

                entity.Property(e => e.Vk).HasColumnName("VK");
            });

            modelBuilder.Entity<TabReportNachVertreterAccessDataCenterline>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("tab_ReportNachVertreter_AccessData_Centerline");
                ...
                entity.Property(e => e.KeyAccount).HasMaxLength(255);
            ...
            modelBuilder.Entity<VCubeReportNachVertreter>(entity =>
            {
                ...
                entity.Property(e => e.IsOrderWithoutFixedCustomer).HasColumnName("IS_OrderWithoutFixedCustomer");
            ...
            modelBuilder.Entity<VCubeReportNachVertreterNonUniqueBackup>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_Cube_ReportNachVertreter_NonUnique_backup");
            ...
            modelBuilder.Entity<VDprSport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_DPR-Sport");
                ...
                entity.Property(e => e.EstimatedEnd)
                    .IsRequired()
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("EstimatedEND");
                ...
                entity.Property(e => e.Fridate)
                    .HasColumnType("date")
                    .HasColumnName("FRIDate");

                entity.Property(e => e.Friresult)
                    .HasMaxLength(50)
                    .HasColumnName("FRIResult");

                entity.Property(e => e.Laboratory).HasMaxLength(50);
                ...
                entity.Property(e => e.QuantityOrderedByClient)
                    .HasMaxLength(23)
                    .IsUnicode(false);

                entity.Property(e => e.SaleDate).HasColumnType("date");

                entity.Property(e => e.SamplePickResult).HasMaxLength(50);
            ...
            modelBuilder.Entity<VDprqbrow>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_DPRQBRows");
            ...
            modelBuilder.Entity<VProductionStatusHistory>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_ProductionStatusHistory");

                entity.Property(e => e.IdOrder).HasMaxLength(511);

                entity.Property(e => e.OutputTotal).HasColumnName("output total");
            ...
            modelBuilder.Entity<VSportAnalysis>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_SportAnalysis");
                ...
                entity.Property(e => e.Clients).HasMaxLength(255);
                ...
                entity.Property(e => e.EkInDollar).HasColumnName("EK in DOLLAR");

                entity.Property(e => e.EkInEuro).HasColumnName("EK in EURO");
                ...
                entity.Property(e => e.LatestDailyOutput).HasColumnName("Latest Daily Output");
                ...
                entity.Property(e => e.Output2).HasColumnName("output 2");

                entity.Property(e => e.Output3).HasColumnName("output 3");

                entity.Property(e => e.OutputSum).HasColumnName("output Sum");
            ...
            modelBuilder.Entity<VSportStatusRow>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_SportStatusRows");
                ...
                entity.Property(e => e.CartonHeight).HasColumnType("decimal(4, 2)");

                entity.Property(e => e.CartonLength).HasColumnType("decimal(4, 2)");
